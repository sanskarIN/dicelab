export const en = {
  ...
  roll: {
    ...
    presetExportSuccess: 'Preset file ready.',
    presetExportFailed: 'Preset file could not be saved.',
    presetImportSuccess: (count: number) => `Imported ${count} ${count === 1 ? 'preset' : 'presets'}.`,
    presetImportFailed: 'Preset file could not be imported.',
    reset: 'Reset',
    deletePreset: 'Delete',
